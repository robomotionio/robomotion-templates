# Salesforce Lead Business Data

Every 15 minutes, takes the leads Salesforce has touched most recently, turns each website into a bare domain, looks the company up in the Google Business listings database, and writes the name, description, categories, address, rating and price level back onto the Salesforce record.
...
- [Get Business Data for Salesforce leads with DataForSEO + Make](https://dataforseo.com/templates/get-business-data-for-salesforce-leads-with-dataforseo-make/) — original make template

...
flow.create('a1b2c4', 'Extract Stories Substack Publication Archive', function (f) {
  f.node('c01000', 'Core.Flow.Comment', 'Comment', { optText: '### Substack Archive Posts\n\nExtracts posts from a Substack archive — title, description, date, likes, comments, link, and image — into a CSV.\n\nEnter a publication URL when prompted.' });

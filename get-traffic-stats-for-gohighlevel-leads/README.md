# GoHighLevel Lead Traffic Stats

Every 15 minutes, takes the leads GoHighLevel has touched most recently, turns each website into a bare domain, estimates how much organic search traffic that domain gets, and writes the numbers back onto the GoHighLevel record.
...
- [Get Traffic Stats for GoHighLevel leads with DataForSEO + Make](https://dataforseo.com/templates/get-traffic-stats-for-gohighlevel-leads-with-dataforseo-make/) — original make template

...
flow.create('5709e224-836b-4fd7-c1a5-be426df83970', 'New AI Overview Keywords by Email', (f) => {
  ...
  f.node('a1f307', 'Core.Flow.Comment', 'About', {
    optText: '### Get new ranked keywords in Google AIO\n' +
      'Each week, find the keywords where your domains are now cited inside Google\'s AI Overview and email the new ones.\n' +
      'An AI Overview citation is becoming the position-zero of the AI era: it is what the answer is built from, whether or not the user ever clicks through. Tracking it weekly tells you which pages Google trusts as a source.'
  });

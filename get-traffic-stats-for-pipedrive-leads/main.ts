...
flow.create('5fcbef72-0d2f-4d3d-ea12-ea81ab390f5d', 'Pipedrive Lead Traffic Stats', (f) => {
...
msg.field_map = { etv: 'REPLACE_WITH_ETV_FIELD_KEY', organic_keywords: '', organic_traffic_cost: '', paid_etv: '' };
return msg;`
    })

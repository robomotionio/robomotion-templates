...
flow.create('1b87ab3e-c9eb-4fdf-a678-ac4dce7f5b19', 'ActiveCampaign Lead Traffic Stats', (f) => {
  f.addDependency('Robomotion.DataForSEO', '1.0.0');

  f.node('f19b52', 'Core.Flow.Comment', 'About', {
    optText: '### Get Traffic Stats for ActiveCampaign leads\n' +
      'Every 15 minutes, take the leads ActiveCampaign has touched most recently, turn each one\'s website into a bare domain, estimate how much organic search traffic that domain gets, and write the numbers back onto the ActiveCampaign record.\n' +
      '\n' +
...
msg.field_map = { etv: '10', organic_keywords: '', organic_traffic_cost: '', paid_etv: '' };
return msg;`
    })

...
flow.create('a1b2cb', 'Extract Group Posts Indie Hackers', function (f) {
  f.node('c01000', 'Core.Flow.Comment', 'Comment', { optText: '### Indie Hackers Group Posts\n\nExtracts posts from an Indie Hackers group — title, author, upvotes, date, comment count, and link — into a CSV.' });

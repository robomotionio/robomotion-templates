...
return msg;`,
    ...
    .then('b11004', 'Core.Net.Download', 'Download sample.docx', {
      inUrl: Custom('https://public-files.robomotion.io/templates/scripting/extract-text-from-word-document/fixtures/sample.docx'),
      inPath: Message('_dl_sample_docx'),

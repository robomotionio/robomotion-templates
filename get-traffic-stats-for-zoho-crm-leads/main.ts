...
flow.create('71ed0184-2f41-4f5f-ac34-0ca3cd5b217f', 'Zoho CRM Lead Traffic Stats', (f) => {
  f.addDependency('Robomotion.DataForSEO', '1.0.0');
  f.addDependency('Robomotion.ZohoCRM', '1.0.2');

  f.node('f19b52', 'Core.Flow.Comment', 'About', {
    optText: '### Get Traffic Stats for Zoho CRM leads\n' +
      'Every 15 minutes, take the leads Zoho CRM has touched most recently, turn each one\'s website into a bare domain, estimate how much organic search traffic that domain gets, and write the numbers back onto the Zoho CRM record.\n' +
      '\n' +
...
msg.field_map = { etv: 'ETV', organic_keywords: 'Organic_Keywords', organic_traffic_cost: 'Organic_Traffic_Cost', paid_etv: 'Paid_ETV' };
return msg;`
    })

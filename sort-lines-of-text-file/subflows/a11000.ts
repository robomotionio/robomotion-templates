...
return msg;`,
    ...
    .then('b11004', 'Core.Net.Download', 'Download unsorted.txt', {
      inUrl: Custom('https://public-files.robomotion.io/templates/text-manipulation/sort-lines-of-text-file/fixtures/unsorted.txt'),
      inPath: Message('_dl_unsorted_txt'),

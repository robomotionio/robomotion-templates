# Monday CRM Lead Traffic Stats

Every 15 minutes, takes the leads monday has touched most recently, turns each website into a bare domain, estimates how much organic search traffic that domain gets, and writes the numbers back onto the monday record.
...
- [Get Traffic Stats for Monday CRM leads with DataForSEO + Make](https://dataforseo.com/templates/get-traffic-stats-for-monday-crm-leads-with-dataforseo-make/) — original make template

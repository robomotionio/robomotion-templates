...
flow.create('a1b2c8', 'Extract Experts Ghost', function (f) {
  f.node('c01000', 'Core.Flow.Comment', 'Comment', { optText: '### Ghost Experts Directory\n\nExtracts experts from the Ghost directory — name, image, and profile link — into a CSV.' });

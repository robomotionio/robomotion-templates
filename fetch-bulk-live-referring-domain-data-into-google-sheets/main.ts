...
flow.create('5d8b2fa1-063c-4e79-b4a5-2c917e0d6b38', 'Bulk Referring Domain Data', (f) => {
  ...
  f.node('91be2d', 'Core.Trigger.Inject', 'Run', { optOnce: true, optOnceDelay: 1 })
    .then('4a8e30', 'Core.Programming.Function', 'Set Parameters', {
      func: `msg.spreadsheet_url = 'https://docs.google.com/spreadsheets/d/1Cp4YEGB8sX3YjJQPo1NOMNcU4GUTUIgzytDg2zxANZQ/edit';
...
return msg;`
    ...
    .then('e7104b', 'Robomotion.DataForSEO.Account.RawRequest', 'Get Referring Domain Counts', {
      inPath: Custom('/backlinks/bulk_referring_domains/live'),
...
msg.table = { columns: ['Target', 'Date', 'Referring domains', 'Nofollow referring domains', 'Referring main domains', 'Nofollow main referring domains'], rows: rows };

...
flow.create('a1c004', 'Extract Job Details Working Nomads', function (f) {
  f.node('c01000', 'Core.Flow.Comment', 'Comment', { optText: '### Working Nomads Job Details\n\nExtracts a Working Nomads job — title, company, location, job type, date posted, and apply link — into a CSV.\n\nEnter a job URL when prompted.' });

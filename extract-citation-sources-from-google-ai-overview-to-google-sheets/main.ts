...
flow.create('a4f1c9d2-6b83-4e17-9c05-2fd8a1e7b430', 'AI Overview Citations to Sheets', (f) => {
  ...
  f.node('c1a204', 'Core.Flow.Comment', 'About', {
    optText: '### Extract citation sources from Google AI Overview\n' +
      'Every 7 days, pull the Google SERP for a keyword with the AI Overview block loaded, collect every source the ' +
      'AI Overview cites, and append them to a Google Sheet with the Source, Domain, URL, Title and Text columns.\n\n' +

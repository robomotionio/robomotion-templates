...
return msg;`,
    ...
    .then('b11004', 'Core.Net.Download', 'Download tables.pdf', {
      inUrl: Custom('https://public-files.robomotion.io/templates/pdf-automation/extract-tables-from-pdf/fixtures/tables.pdf'),
      inPath: Message('_dl_tables_pdf'),

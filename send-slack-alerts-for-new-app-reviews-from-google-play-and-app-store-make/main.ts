...
flow.create('6284a0ed-957e-40e9-f36b-21d7aec48653', 'App Review Alerts to Slack', (f) => {
...
return [msg, null];`
  ...
  f.node('4d09a7', 'Robomotion.Slack.SendMessage', 'Post Google Reviews', {
...
return [msg, null];`
  ...
  f.node('c84f60', 'Robomotion.Slack.SendMessage', 'Post App Store Reviews', {
    inChannelName: Message('slack_channel'),
    inMessage: Message('announcement'),
    optToken: { vaultId: '_', itemId: '_' }
  });

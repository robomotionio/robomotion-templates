...
flow.create('e2a70c58-b13d-4f6a-9d84-7c15e0b3a962', 'Bulk Domain Rank Checker', (f) => {
  ...
  f.node('6c04b7', 'Core.Flow.Comment', 'Read targets', {
    optText: '#### Read targets\nThe sheet needs a `Target` column; `Date` and `Rank` are filled in by this flow.\n\n' +
      'Example sheet: https://docs.google.com/spreadsheets/d/189GEF2UkVFE-KMvp3xGusCp-r7uz3U84qnb07OzwUvo/edit'
  });
